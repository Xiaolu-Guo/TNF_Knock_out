function [peaks, locs, HMW, prom, heights] = globalpeaks_new(vect, baseline, num_peaks)
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
% [peaks, locs] = globalpeaks(vect, num_peaks) -- old function call before
% 6/19/2020 - edited by AS
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
